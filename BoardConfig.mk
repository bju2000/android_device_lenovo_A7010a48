...
TARGET_SPECIFIC_HEADER_PATH := device/lenovo/A7010a48/include
...
TARGET_KERNEL_CONFIG := A7010a48_cyanogenmod13_debug_defconfig
TARGET_KERNEL_CROSS_COMPILE_PREFIX := aarch64-linux-android-
MTK_APPENDED_DTB_SUPPORT := yes
BOARD_KERNEL_IMAGE_NAME := Image.gz-dtb
 
# prebuild kernel as fallback
#TARGET_PREBUILT_KERNEL := device/lenovo/A7010a48/prebuilt/kernel
BOARD_HAS_NO_SELECT_BUTTON := true

# system.prop
TARGET_SYSTEM_PROP := device/lenovo/A7010a48/system.prop
...
# recovery
#TARGET_RECOVERY_INITRC := device/lenovo/A7010a48/recovery/init.mt6753.rc
TARGET_RECOVERY_FSTAB := device/lenovo/A7010a48/recovery/root/fstab.mt6753
